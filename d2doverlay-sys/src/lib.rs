...
extern {
  pub fn overlay_options_sys(option : u32);

  pub fn overlay_setup_sys(callback: DirectOverlayCallback);
  pub fn overlay_setup_with_window_sys(callback: DirectOverlayCallback, window: HWND);
  pub fn overlay_setup_with_process_sys(callback: DirectOverlayCallback, process: *const c_char);

  pub fn draw_box_sys(x: f32, y: f32, width: f32, height: f32, thickness: f32, r: f32, g: f32, b: f32, a: f32, filled : bool);

  pub fn draw_line_sys(x1: f32, y1: f32, x2: f32, y2: f32, thickness: f32, r: f32, g: f32, b: f32, a: f32);
  ...
  pub fn draw_circle_sys(x: f32, y: f32, radius: f32, thickness: f32, r: f32, g: f32, b: f32, a: f32, filled: bool);

  // Allows you to draw an elipse.  Same as a circle, except you have two different radii, for width and height.
  pub fn draw_ellipse_sys(x: f32, y: f32, width: f32, height: f32, thickness: f32, r: f32, g: f32, b: f32, a: f32, filled: bool);

  // Draw a string on the screen.  Input is in the form of an std::string.
  pub fn draw_string_sys(str : *const c_char, fontSize: f32, x: f32, y: f32, r: f32, g: f32, b: f32, a: f32);
}
